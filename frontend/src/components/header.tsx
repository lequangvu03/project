...
export default function Header() {
  return (
    <header className='sticky top-8 z-10 flex h-[100px] items-center justify-between rounded-2xl bg-[var(--secondary-color)] px-4 shadow-sm shadow-white/20'>
      ...
      <section className='flex items-center gap-[2px]'>
        <Link
          href='/admin/profile'
          className='flex items-center justify-between gap-1 rounded-3xl bg-slate-600 px-2 py-1 transition-all hover:opacity-80'
        >
