 ...
 * */
bookingRouter.put('/:id', accessTokenValidator, updateTableValidator, wrapRequestHandler(updateBookingController))
 ...
 * response: {message: string, result: TableType}
 * */
bookingRouter.delete('/:id', accessTokenValidator, deleteTableValidator, wrapRequestHandler(deleteBookingController))
