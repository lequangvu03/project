 ...
 * Public apis
 */
export const publicGet = (url: string, params?: any) => publicAxiosInstance.get(url, { params }).then((res) => res.data)
...
export const publicPost =(url: string, body?: any) =>
  publicAxiosInstance.post(url, body).then((res) => res.data)
...
export const publicPatch = (url: string, params?: any) => publicAxiosInstance.patch(url, params).then((res) => res.data)
