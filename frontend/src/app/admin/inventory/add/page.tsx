  ...
  if (ingredients?.result) {
    return (
      <div className='flex h-full justify-between gap-8'>
        <div className='flex flex-[0.65] flex-col gap-8'>
          ...
          <div className='grid grid-cols-4 gap-8'>
            ...
            <Link
              ...
              className='flex flex-col items-center justify-center gap-3 rounded-lg bg-[#1F1D2B] px-2 py-6'
            >
        ...
        <div className='flex h-fit flex-[0.35] flex-col gap-3 rounded-sm bg-[#1F1D2B] p-4'>
          <header className='flex flex-col gap-1'>
            <h3 className='text-[22px]'>Inventory</h3>
            <DateTime />
          </header>
